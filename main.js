...
function my_keydown(e)
{
	...
	ball_y = ball_y + block_image_height;	
	 ...
	 console.log("cuando se presione la tecla bajo, X = " + ball_x + ", Y =" +ball_y);
   Canvas.remove(ball_obj);
   new_image();
	...
	function left()
	{
		if(ball_x >5)
		{
			...
			console.log("cuando sepresione la tecla izquierda, X =  " + ball_x + " , Y = "+ball_y);
			canvas.remove(ball_obj);
			new_image();
		}
	}
	...
	function right()
	{
		if(ball_x <=1050)
		{
			...
			console.log("cuando se presion la tecla derecha, X =  " + ball_x + " , Y = "+ball_y);
			canvas.remove(ball_obj);
			new_image();
		}		
